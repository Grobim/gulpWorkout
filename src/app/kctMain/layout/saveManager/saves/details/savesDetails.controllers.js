(function() {
  ...
  function SavesDetailsMainController(
    $intFirebaseObject,
    $stateParams,
    SaveRef,
    breadCrumbModelService
  ...
  function SaveDetailsController(
    ...
    function init() {
      ...
      if (isCreation()) {
        ...
        LoadingSpinner.loading('saveModListLoad');
        ...
        _this.modList = $intFirebaseArray(new SaveInclModRef($stateParams.saveId));

        _this.modList.$loaded(function() {
          LoadingSpinner.loaded('saveModListLoad');
        });

        _this.modList.$watch(onQueryChange);
    ...
    function onQueryChange() {
      _this.tableModList = MdDataTableUtils.onQueryChange(_this.modList, _this.tableConfig);
      SaveInclModsService.addTitleToSaveInclMods(_this.tableModList);
    }
